...
function changing_bg() {
  ...
  if(window_width <= 770){
    ...
    document.querySelector('#first_page').childNodes[1].setAttribute('src','assets/page_1_bg_mobile.jpg');
    document.querySelector('#second_page').childNodes[1].setAttribute('src','assets/page_2_bg_mobile.jpg');
    document.querySelector('#third_page').childNodes[1].setAttribute('src','assets/page_3_bg_mobile.jpg');
    document.querySelector('#fourth_page').childNodes[1].setAttribute('src','assets/page_4_bg_mobile.jpg');
  }
  else{
    
    document.querySelector('#first_page').childNodes[1].setAttribute('src','assets/page_1_bg.jpg');
    document.querySelector('#second_page').childNodes[1].setAttribute('src','assets/page_2_bg.jpg');
    document.querySelector('#third_page').childNodes[1].setAttribute('src','assets/page_3_bg.jpg');
    document.querySelector('#fourth_page').childNodes[1].setAttribute('src','assets/page_4_bg.jpg');
  }
}
...
function position_height() {
  console.log(document.getElementsByClassName('home_follow_circle')[0].offsetTop);
  console.log(document.getElementsByClassName('home_follow_circle')[0].offsetHeight);
...
function stats_display(){
  ...
  if(scroll_view >= stats_top+(window.innerHeight*(20/100)) && scroll_view <= stats_bottom + (window.innerHeight*(80/100))) {
    ...
    bar_name.forEach((ele) => {ele.style.opacity = '1';});
    
    function display_bar(){
      let bar_value = document.querySelectorAll('.bar_value');
      bar_value.forEach((ele) => {ele.style.width = '100%';});
      
      setTimeout(display_bar_value, 500);
      function display_bar_value() {
        bar_value.forEach((ele) => {ele.childNodes[1].style.transform = 'scaleX(1)';});
      }
    }
    ...
    console.log('here');
    let bar_name = document.querySelectorAll('.bar_name');
    bar_name.forEach((ele) => {ele.style.opacity = '0';});

    let bar_value = document.querySelectorAll('.bar_value');
    bar_value.forEach((ele) => {ele.style.width = '0';});

    bar_value.forEach((ele) => {ele.childNodes[1].style.transform = 'scaleX(0)';});
...
function animate(){
  ...
  setTimeout(()=>{
    ...
    setTimeout(() => {
      ...
      icons.forEach((ele) => {
        let time = i+200;
        setTimeout(()=>{ele.style.opacity = '1';},time);
        i=i+150;
      });
      setTimeout(()=>{
        ...
        setTimeout(()=>{
          ...
          q_cards.forEach((ele) => {
            if(ele.classList != undefined) {
              ...
              setTimeout(()=>{ele.style.opacity = '1';},150);
